...
##Last Edit by Aishwarya on 6th November 2018.##
...
#data <- read.table(file="/project/GCRB/Banaszynski_lab/shared/yourfolder/cuffdiff_output_D0_129vs282_DE.txt", sep="\t", header=T)
#data1 <- read.csv(file.choose(),sep = ",",header = T) #upload cuffdiff output in text file
