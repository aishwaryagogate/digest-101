...
computeMatrix reference-point --referencePoint center -R p300merged_2500bp_distal_peaks.bed -b 3000 -a 3000 --sortRegions no -S /project/GCRB/Banaszynski_lab/shared/Sara/H3.3_project_Sara/ChIP-Seq/Analyis/New_analysis/bigwig_normalized/129_H3K27ac_SI_rep3_norm.nodup.bw /project/GCRB/Banaszynski_lab/shared/Sara/H3.3_project_Sara/ChIP-Seq/Analyis/New_analysis/bigwig_normalized/282_H3K27ac_SI_rep3_norm.nodup.bw --skipZeros -o matrix_1.gz --outFileSortedRegions matrix_1.bed --numberOfProcessors max
...
computeMatrix reference-point --referencePoint TSS -R mm10_RefSeqgenes.bed -b 3000 -a 3000 --sortRegions no -S /project/GCRB/Banaszynski_lab/shared/Sara/H3.3_project_Sara/ChIP-Seq/Analyis/New_analysis/bigwig_normalized/129_H3K27ac_SI_rep3_norm.nodup.bw /project/GCRB/Banaszynski_lab/shared/Sara/H3.3_project_Sara/ChIP-Seq/Analyis/New_analysis/bigwig_normalized/282_H3K27ac_SI_rep3_norm.nodup.bw --skipZeros -o matrix_2.gz --outFileSortedRegions matrix_2.bed --numberOfProcessors max
