...
main(){
    ...
    if [ $ucsc_reference = 'hg19' ]; then
        ...
        index=$iGENOMES_DB_DIR\/Mus_musculus/UCSC/$ucsc_reference/Sequence/Bowtie2Index/genome
    elif [ $ucsc_reference = 'mm10dm3' ]; then
        index='/project/GCRB/Banaszynski_lab/shared/6_run/160811_NB501597_0018_AHGTWNBGXY/ChiP_SI_correctindex/raw_fastq/bwt/bt2_mm10_dm3'
    else
        usage
    fi
